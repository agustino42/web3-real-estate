...
contract RealEstate {
  ...
  function listProperty(
   ...
   external returns (uint256) {
    ...
    require(price > 0, "El Precio tiene que ser Mayor que 0.");
     ...
     property.propertyAddres = _propertyAddres;
     property.description = _description;
    
    emit PropertyListed(productId, owner, price);

    return productId; // <--- Add this line
}
   ...
   external returns (uint256) {
    ...
    Property storage property = properties[productId];
    require(property.owner == owner, "No tienes permiso para actualizar esta propiedad");
    
    property.propertyTitle = _propertyTitle;
    property.category = _category;
    property.images = _images;
    property.propertyAddres = _propertyAddress;
    property.description = _description;
   ...
   function updatePrice (
    ...
    return "El precio de esta Propiedad se actualizo";
}
   ...
   function buyProperty (
    ...
    address buyer
     ...
     external payable{
        ...
        require(amount >= properties[id].price, "Insuficiente Fondos");
...
function getProperty(uint256 id) external view returns (
   ...
   function addReview(
    ...
    require(rating >= 1 && rating <= 5, "tiene q ser entre 1 y 5");
